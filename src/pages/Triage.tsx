  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex space-x-4">
        {/* Left Section - Patient Queue (Larger) */}
          ...
          <div className="bg-white rounded-lg shadow-sm">
            {filteredPatients.length === 0 ? (
              <div className="p-6 text-center">
                ...
                <p className="text-sm text-gray-500">There are currently no patients in this category</p>
              </div>
            ) : (
              <div className="divide-y divide-gray-200">
                {filteredPatients.map((patient) => (
                  <div key={patient.id} className="p-3 hover:bg-gray-50">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <Link 
                              ...
                              className="bg-primary-50 text-primary-600 hover:bg-primary-100 px-2 py-1 rounded text-xs font-medium inline-flex items-center"
                            >
