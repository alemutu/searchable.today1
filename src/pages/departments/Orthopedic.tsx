  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center space-x-2">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">Orthopedic Department</h1>
          <p className="text-xs text-gray-500">Bone & Joint Specialist Care</p>
        </div>
      </div>
      ...
      <div className="flex space-x-2">
        ...
        >
          <Bone className="h-4 w-4 text-primary-500" />
                              ...
                              <div className="flex space-x-1">
                                ...
                                {patient.assigned_to === user?.id && !patient.external_location && (
                                  <>
                                    ...
                                    >
                                      Start Consultation <Bone className="h-3 w-3 ml-1" />
                                    </button>
                                    <button 
                                ...
                                {patient.assigned_to === user?.id ? (
                                  <>
                                    <Link 
                                      ...
                                      className="btn btn-primary inline-flex items-center text-xs py-1 px-2 rounded-lg"
                                    >
                                      Continue <Bone className="h-3 w-3 ml-1" />
                                    </Link>
                                    <button 
                                      onClick={() => handleReleaseAssignment(patient.id)}
                                      className="btn btn-outline inline-flex items-center text-xs py-1 px-2 rounded-lg"
        ...
        <div className="w-1/3 space-y-3">
                        ...
                        <div className="flex items-center">
                          <div className="mr-2">
                            {patient.current_flow_step === 'waiting_consultation' ? (
                              ...
                              <Bone className="h-3.5 w-3.5 text-primary-500" />
                            )}
                          </div>
                          <div>
                            ...
                            <p className="text-xs text-gray-500 line-clamp-1">
                              {patient.condition || `${calculateAge(patient.date_of_birth)} years`}
                            </p>
                          </div>
                        </div>
                        <Link
          ...
          <div className="bg-white rounded-lg shadow-sm p-3">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-1.5 rounded-md hover:bg-gray-50">
                <div className="flex items-center">
                  <Bone className="h-4 w-4 text-primary-500 mr-1.5" />
            ...
            <div className="space-y-2">
              <div>
                ...
                <div className="grid grid-cols-2 gap-1 text-xs">
                  <div className="text-gray-600">Fractures</div>
                  <div className="text-right">Bone breaks</div>
                  <div className="text-gray-600">Osteoarthritis</div>
                  <div className="text-right">Joint degeneration</div>
                  <div className="text-gray-600">Tendonitis</div>
                  <div className="text-right">Tendon inflammation</div>
                  <div className="text-gray-600">Scoliosis</div>
                  <div className="text-right">Spine curvature</div>
                </div>
              </div>
            </div>
          </div>
