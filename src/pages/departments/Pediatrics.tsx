  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center space-x-2">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">Pediatrics</h1>
                      ...
                      <div className="ml-3 flex-1">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            >
                              {activeTab === 'waiting' ? 'Start Consultation' : 'Continue'} <Baby className="h-3 w-3 ml-1" />
                            </Link>
                          </div>
                        </div>
                        <div className="mt-0.5">
                          <span className="text-xs">{calculateAge(patient.date_of_birth)} • {patient.date_of_birth}</span>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="w-1/3 space-y-3">
          ...
          <div className="bg-white rounded-lg shadow-sm p-3">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-1.5 rounded-md hover:bg-gray-50">
                <div className="flex items-center">
                  <Baby className="h-4 w-4 text-primary-500 mr-1.5" />
          ...
          <div className="bg-white rounded-lg shadow-sm p-3">
            ...
            <div className="space-y-2">
              <div>
                <h3 className="text-xs font-medium text-gray-700 mb-1">Growth Milestones</h3>
