  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center space-x-2">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Cardiology</h1>
      ...
      <div className="flex space-x-4">
                      ...
                      <div className="ml-4 flex-1">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            >
                              {activeTab === 'waiting' ? 'Start Consultation' : 'Continue'} <Heart className="h-4 w-4 ml-1" />
                            </Link>
                          </div>
                        </div>
                        <div className="mt-1">
        ...
        <div className="w-1/3 space-y-4">
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-sm font-medium text-gray-700 mb-2">Common Conditions</h3>
