...
const Physiotherapy: React.FC = () => {
  ...
  const handleAssignToMe = async (patientId: string) => {
    ...
    try {
      ...
      navigate('/departments/physiotherapy');
    } catch (error: any) {
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center space-x-2">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">Physiotherapy</h1>
          <p className="text-xs text-gray-500">Physical Rehabilitation & Therapy</p>
        </div>
      </div>
      ...
      <div className="flex space-x-2">
        ...
        >
          <ActivitySquare className="h-4 w-4 text-primary-500" />
          <span className="font-medium text-sm">In Therapy</span>
          ...
          <div className="bg-white rounded-lg shadow-sm">
            {filteredPatients.length === 0 ? (
              <div className="p-6 text-center">
                ...
                <h3 className="text-base font-medium text-gray-900 mb-1">No patients {activeTab === 'waiting' ? 'waiting' : 'in therapy'}</h3>
                          ...
                          <div>
                            ...
                            <div className="flex items-center text-xs text-gray-500">
                              ...
                              {patient.session_number && (
                                <>
                                  <span className="mx-1">•</span>
                                  <span>Session #{patient.session_number}</span>
                                </>
                              )}
                            </div>
                          </div>
        ...
        <div className="w-1/3 space-y-3">
          ...
          <div className="bg-white rounded-lg shadow-sm p-3">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-1.5 rounded-md hover:bg-gray-50">
                <div className="flex items-center">
                  <ActivitySquare className="h-4 w-4 text-primary-500 mr-1.5" />
                  <span className="text-sm text-gray-700">In Therapy</span>
                </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-3">
            ...
            <div className="space-y-2">
              <div>
                <h3 className="text-xs font-medium text-gray-700 mb-1">Common Treatments</h3>
                <div className="grid grid-cols-2 gap-1 text-xs">
                  <div className="text-gray-600">Manual Therapy</div>
                  <div className="text-right">Joint mobilization</div>
                  <div className="text-gray-600">Exercise Therapy</div>
                  <div className="text-right">Strength training</div>
                  <div className="text-gray-600">Electrotherapy</div>
                  <div className="text-right">TENS, ultrasound</div>
                  <div className="text-gray-600">Hydrotherapy</div>
                  <div className="text-right">Water-based rehab</div>
                </div>
              </div>
            </div>
          </div>
