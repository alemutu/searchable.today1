...
const EyeClinic: React.FC = () => {
  ...
  const handleStartConsultation = async (patientId: string) => {
    ...
    try {
      ...
      // Show notification
      addNotification({
        message: `Started examination for ${patient.first_name} ${patient.last_name}`,
        type: 'success',
        duration: 3000
      });
    ...
    <div className="space-y-3">
      <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">Ophthalmology & Vision Care</p>
        </div>
      </div>
      ...
      <div className="flex space-x-2">
        ...
        >
          ...
          <span className="font-medium text-sm">In Examination</span>
          ...
          <div className="bg-white rounded-lg shadow-sm">
            {filteredPatients.length === 0 ? (
              <div className="p-6 text-center">
                ...
                <h3 className="text-base font-medium text-gray-900 mb-1">No patients {activeTab === 'waiting' ? 'waiting' : 'in examination'}</h3>
                            ...
                            {activeTab === 'waiting' ? (
                              <div className="flex space-x-1">
                                ...
                                {patient.assigned_to === 'current_user' && (
                                  ...
                                  >
                                    Start Examination <Eye className="h-3 w-3 ml-1" />
                                  </button>
                                )}
                              </div>
                            ) : (
                              <Link 
                                ...
                                className="btn btn-primary inline-flex items-center text-xs py-1 px-2"
                              >
                                Continue <Eye className="h-3 w-3 ml-1" />
                              </Link>
                            )}
                          </div>
                        </div>
        ...
        <div className="w-1/3 space-y-3">
          ...
          <div className="bg-white rounded-lg shadow-sm p-3">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-1.5 rounded-md hover:bg-gray-50">
                <div className="flex items-center">
                  <Eye className="h-4 w-4 text-primary-500 mr-1.5" />
                  <span className="text-sm text-gray-700">In Examination</span>
                </div>
            ...
            <div className="space-y-2">
              <div>
                ...
                <div className="grid grid-cols-2 gap-1 text-xs">
                  <div className="text-gray-600">Myopia</div>
                  <div className="text-right">Nearsightedness</div>
                  <div className="text-gray-600">Hyperopia</div>
                  <div className="text-right">Farsightedness</div>
                  <div className="text-gray-600">Astigmatism</div>
                  <div className="text-right">Irregular cornea</div>
                  <div className="text-gray-600">Presbyopia</div>
                  <div className="text-right">Age-related focus</div>
                </div>
              </div>
            </div>
          </div>
