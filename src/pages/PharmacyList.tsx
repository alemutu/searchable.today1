    ...
    <div className="space-y-4">
      <div className="flex items-center space-x-2">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Medication Management & Dispensing</p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg shadow-sm">
            {filteredOrders.length === 0 ? (
              <div className="p-8 text-center">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-1">No prescriptions {activeTab === 'pending' ? 'pending' : 'processing'}</h3>
                <p className="text-gray-500">There are currently no prescriptions in this category</p>
              </div>
            ) : (
              <div className="divide-y divide-gray-200">
                {filteredOrders.map((order) => (
                  <div key={order.id} className={`p-4 hover:bg-gray-50 ${order.is_emergency ? 'bg-error-50' : ''}`}>
                      ...
                      <div className="ml-4 flex-1">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            >
                              Process Order <Pill className="h-4 w-4 ml-1" />
                            </Link>
                          </div>
                        </div>
                        <div className="mt-1">
        ...
        <div className="w-1/3 space-y-4">
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-lg font-medium text-gray-900">Pharmacy Overview</h2>
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link to="/pharmacy/inventory" className="flex items-center p-3 rounded-md hover:bg-gray-50 border border-gray-200">
          ...
          <div className="bg-white rounded-lg shadow-sm p-4">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-sm font-medium text-gray-700 mb-2">Common Medications</h3>
