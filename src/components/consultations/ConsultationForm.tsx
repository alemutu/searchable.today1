...
import { User as UserIcon, Calendar, Stethoscope, FileText, Pill, Save, ArrowLeft, Plus, Trash2, CheckSquare, AlertTriangle, FileCheck, ArrowUpRight, FlaskRound as Flask, Microscope, Building2 } from 'lucide-react';
