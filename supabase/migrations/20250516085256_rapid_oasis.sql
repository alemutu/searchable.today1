/*
  # Create a real hospital with all related records
...
BEGIN
  ...
  INSERT INTO public.licenses (
    ...
    0,
    '{}'::jsonb,
    '{"billing_cycle": "monthly", "auto_renew": true, "payment_method": "credit_card", "next_invoice_date": "' || 
    (CURRENT_DATE + INTERVAL '1 month')::date || '"}'::jsonb
  ) ON CONFLICT DO NOTHING;
  ...
  INSERT INTO public.profiles (
    ...
    'admin-' || substr(md5(random()::text), 1, 10),
    'Hospital',
    'Admin',
