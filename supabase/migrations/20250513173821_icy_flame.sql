/*
  # Create Hosi Plus Hospital with Free License
  
  1. Changes
    - Create a new hospital record for Hosi Plus
    - Create a free license with all modules enabled
    - Create an admin user for the hospital
    
  2. Security
    - Set secure password for the admin user
    - Enable all modules for the free license
*/

-- Create the Hosi Plus hospital
