/*
  ...
  1. New Tables
    - `reports` - Stores report definitions and configurations
    - `report_executions` - Stores the history of report runs and their results
    - `report_schedules` - Stores scheduling information for automated reports
    - `report_subscriptions` - Stores user subscriptions to reports

  2. Security
    - Enable RLS on all tables
    - Add policies for proper access control
    - Hospital admins can manage reports for their hospital
    - Super admins can manage all reports
    - Users can view reports they have access to

  3. Changes
    - Added report categories and types
