/*
  ...
  1. Changes
    - Create a developer test account with email dev@hms.dev
    - Set password to dev123
    - Assign admin role for full system access
    - Create corresponding profile entry
    
  2. Security
    - User has full access to all system features for testing
    - Can simulate all workflows
*/
